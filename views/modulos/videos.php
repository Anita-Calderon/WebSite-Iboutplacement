<section id="videos" class="container_video py-5">
    ...
    <div class="container text-center wow animate__ animate__fadeInUp  animated" data-wow-duration="3s"
        ...
        <div class="row">
            <div class="container_video col-md-6">
                <h3 style="font-size: 20px;"><a href="https://www.youtube.com/watch?v=lOK8SJF-Fls" style="color: black; a:visited: black; a:hover: black; a:active: black;">OUTPLACEMENT EL MEJOR EMPLEO EN EL MENOR TIEMPO POSIBLE</a></h3>
            ...
            <div class="col-md-6">
                <h3 style="font-size: 20px;"><a href="https://youtu.be/GU-zS4aygPU?si=K9JdUmJTWX4ul1ql" style="color: black; a:visited: black; a:hover: black; a:active: black;">COACHING OPTIMIZA LA BÚSQUEDA DE EMPLEO Y DESARROLLA HABILIDADES BLANDAS</a>
                </h3>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <video id="videoContainer" width="100%" controls="controls"
                        src="views/src/OUTPLACEMENT.mp4"><a href="#elmejorempleo" id="closeSimple">x</a></video>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="play-video-2">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-body">
                    <video id="videoContainer" src="views/src/COACHING.mp4" width="100%" controls="controls"><a href="#coaching" id="closeSimple">x</a>
                    </video>
                </div>
            </div>
        </div>
